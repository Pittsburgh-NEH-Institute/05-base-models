...
:balloon: First off, thank you for considering contributing to 05-base-models. :balloon:

All pull-requests are welcome. File a bug report, fix a typo, improve the documentation, or add a new feature. All are helpful, and make 05-base-models better.
